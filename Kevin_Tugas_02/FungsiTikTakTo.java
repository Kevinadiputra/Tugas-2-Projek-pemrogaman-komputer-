...
public class FungsiTikTakTo implements ActionListener{
	...
	FungsiTikTakTo(){
		...
		textfield.setFont(new Font("Hack", Font.BOLD,75));
		textfield.setHorizontalAlignment(JLabel.CENTER);
		textfield.setText("Tic-Tac-To");
		...
		for(int i=0;i<9;i++){
			...
			buttons[i].setFont(new Font("Hack", Font.BOLD, 120));
